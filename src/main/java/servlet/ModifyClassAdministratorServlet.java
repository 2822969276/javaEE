...
@WebServlet(urlPatterns = "/ModifyClassAdministratorServlet")
public class ModifyClassAdministratorServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean flag = classAdministratorDao.ModifyClassAdministratorEmailAndUsernameAndPassword(email, username, password);
        if (flag) {
